...
public class DashboardConfig {
    ...
    public static final String NACOS_SERVER = "customer.nacos.server";

    public static final String NACOS_NAMESPACE = "customer.nacos.namespace";

    public static final String NACOS_GROUP = "customer.nacos.group";
    ...
    public static String getNacosServer() {
        return getConfigStr(NACOS_SERVER);
    }
    ...
    public static String getNacosGroup() {
        return getConfigStr(NACOS_GROUP);
    }
}
